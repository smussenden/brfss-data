---
title: "Exploratory Analysis of CDC's BRFSS Data"
...
bingedrink <- read_csv("C:/Users/rashm/Desktop/Exploratory Analysis/CDC Plot Data/bingedrink.csv")
View(bingedrink)
head(bingedrink)
...
```{r}
smokerbing <- read_csv("C:/Users/rashm/Desktop/Exploratory Analysis/CDC Plot Data/smokerbing.csv")
View(smokerbing)
```
...
frutsumbing <- read_csv("C:/Users/rashm/Desktop/Exploratory Analysis/CDC Plot Data/frutsumbinge.csv")
View(frutsumbing)
...
age80bing <- read_csv("C:/Users/rashm/Desktop/Exploratory Analysis/CDC Plot Data/age80bing.csv")
View(age80bing)
...
vegesumBing <- read_csv("C:/Users/rashm/Desktop/Exploratory Analysis/CDC Plot Data/vegesumBing.csv")
View(vegesumBing)
